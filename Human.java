...
public class Human{
    ...
    public void changePlace(Place toPlace){
        if(toPlace == place){
            ...
            System.out.println(getName() + " перешел из " + place.getPlace().getValue() + " в " + toPlace.getPlace().getValue() + " !");
            setPlace(toPlace);
        }
    }
    public void climbTheStairs(Stairs stairs){
        if (stairs != null){
            if (stairs.getWidth()!= 0 & stairs.getHeight() != 0) {
                System.out.println(getName() + " Поднимается по " + Stairs.toString(stairs.getWidth()) + " и " + Stairs.toString(stairs.getHeight()) +
                        "лестнице ведущей из " + stairs.getDownPlace().getPlace().getValue() + " в " + stairs.getUpPlace().getPlace().getValue());
                ...
                System.out.println(getName() + " Поднимается по лестнице ведущей из " + stairs.getDownPlace().getPlace().getValue() + " в " + stairs.getUpPlace().getPlace().getValue());
    ...
    public void goDownTheStairs(Stairs stairs){
        if (stairs != null){
            if(stairs.getWidth()!= 0 & stairs.getHeight() != 0) {
                System.out.println(getName() + " Спускается по " + Stairs.toString(stairs.getWidth()) + " и " + Stairs.toString(stairs.getHeight()) +
                        "лестнице ведущей из " + stairs.getUpPlace().getPlace().getValue() + " в " + stairs.getDownPlace().getPlace().getValue());
                setPlace(stairs.getDownPlace());
                setPlace(stairs.getDownPlace());
                IntStairs.creak();
                IntStairs.creak();
                ...
                System.out.println(getName() + " Спускается по лестнице ведущей из " + stairs.getUpPlace().getPlace().getValue() + " в " + stairs.getDownPlace().getPlace().getValue());
                setPlace(stairs.getDownPlace());
                IntStairs.creak();
                IntStairs.creak();
                IntStairs.creak();
