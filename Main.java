...
public class Main
{
	public static void main(String[] args) {
		...
		secondBaby.setAccessoriesColor(ChildClothing.Colors.PINK);
		secondBaby.setAccessoriesPicture(ChildClothing.Picture.SQUIRREL);
		secondBaby.setAccessoriesPictureColor(ChildClothing.Colors.RED);
		...
		firstBaby.setAccessoriesColor(ChildClothing.Colors.ORANGE);
		firstBaby.setAccessoriesPicture(ChildClothing.Picture.RABBIT);
		firstBaby.setAccessoriesPictureColor(ChildClothing.Colors.GREEN);
		...
		neznaika.setTopOuterWearColor(ChildClothing.Colors.ORANGE);
		neznaika.setDownOuterWear(ChildClothing.DownOuterWear.TROUSERS);
		neznaika.setDownOuterWearColor(ChildClothing.Colors.YELLOW);
		neznaika.setShoes(ChildClothing.Shoes.BOOTS);
		neznaika.setShoesColor(ChildClothing.Colors.ORANGE);
		neznaika.setAccessories(ChildClothing.Accessories.TIE);
		neznaika.setAccessoriesColor(ChildClothing.Colors.GREEN);
